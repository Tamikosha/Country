...
@XmlType(name = "ListOffStateCAndNGRCon", propOrder = {
        "tListOffStateCAndNGRCon"
})
public class ListOffStateCAndNGRCon {

    @XmlElement(nillable = true)
    protected List<TypeListOffStateCAndNGRCon> tListOffStateCAndNGRCon;
     ...
     * {@link TypeListOffStateCAndNGRCon }
     * 
     * 
     */
    public List<TypeListOffStateCAndNGRCon> getTCountryCodeAndNameGroupedByContinent() {
        if (tListOffStateCAndNGRCon == null) {
            tListOffStateCAndNGRCon = new ArrayList<TypeListOffStateCAndNGRCon>();
        }
        return this.tListOffStateCAndNGRCon;
    }
