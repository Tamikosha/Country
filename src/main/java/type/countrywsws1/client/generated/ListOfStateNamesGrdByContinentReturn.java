...
public class ListOfStateNamesGrdByContinentReturn {

    @XmlElement(name = "ListOfCountryNamesGroupedByContinentResult", required = true)
    protected ListOffStateCAndNGRCon listOfCountryNamesGroupedByContinentResult;
     ...
     * @return
     *     possible object is
     *     {@link ListOffStateCAndNGRCon }
     *     
     */
    public ListOffStateCAndNGRCon getListOfCountryNamesGroupedByContinentResult() {
     ...
     *     
     */
    public void setListOfCountryNamesGroupedByContinentResult(ListOffStateCAndNGRCon value) {
