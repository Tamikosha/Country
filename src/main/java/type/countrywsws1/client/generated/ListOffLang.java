...
@XmlType(name = "ListOffLang", propOrder = {
        "typeLanguage"
})
public class ListOffLang {

    @XmlElement(nillable = true)
    protected List<TypeLanguage> typeLanguage;
     ...
     * 
     */
    public List<TypeLanguage> getTLanguage() {
        if (typeLanguage == null) {
            typeLanguage = new ArrayList<TypeLanguage>();
        }
