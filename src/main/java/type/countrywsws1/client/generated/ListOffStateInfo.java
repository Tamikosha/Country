...
@XmlType(name = "ListOffStateInfo", propOrder = {
        "typeCountryInfo"
})
public class ListOffStateInfo {

    @XmlElement(nillable = true)
    protected List<TypeCountryInfo> typeCountryInfo;
     ...
     * 
     */
    public List<TypeCountryInfo> getTypeCountryInfo() {
        if (typeCountryInfo == null) {
            typeCountryInfo = new ArrayList<TypeCountryInfo>();
        }
        return this.typeCountryInfo;
    }
