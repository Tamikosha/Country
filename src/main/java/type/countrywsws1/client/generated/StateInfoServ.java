    ...
    extends Service
{
    ...
    public StateInfoServ() {
        super(__getWsdlLocation(), COUNTRYINFOSERVICE_QNAME);
    }

    public StateInfoServ(WebServiceFeature... features) {
        super(__getWsdlLocation(), COUNTRYINFOSERVICE_QNAME, features);
    }

    public StateInfoServ(URL wsdlLocation) {
        super(wsdlLocation, COUNTRYINFOSERVICE_QNAME);
    }

    public StateInfoServ(URL wsdlLocation, WebServiceFeature... features) {
        super(wsdlLocation, COUNTRYINFOSERVICE_QNAME, features);
    }

    public StateInfoServ(URL wsdlLocation, QName serviceName) {
        super(wsdlLocation, serviceName);
    }

    public StateInfoServ(URL wsdlLocation, QName serviceName, WebServiceFeature... features) {
    ...
    public StateInfoServiceType getCountryInfoServiceSoap() {
        return super.getPort(new QName("http://www.oorsprong.org/websamples.countryinfo", "CountryInfoServiceSoap"), StateInfoServiceType.class);
    }
     ...
     */
    @WebEndpoint(name = "CountryInfoServiceSoap")
    public StateInfoServiceType getCountryInfoServiceSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.oorsprong.org/websamples.countryinfo", "CountryInfoServiceSoap"), StateInfoServiceType.class, features);
    }
