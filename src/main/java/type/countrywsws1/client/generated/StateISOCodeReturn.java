...
@XmlRootElement(name = "StateISOCodeReturn")
public class StateISOCodeReturn {

    @XmlElement(name = "CountryISOCodeResult", required = true)
    protected String stateIsoCodeRer;
     ...
     *     
     */
    public String getStateIsoCodeRer() {
        return stateIsoCodeRer;
    }
     ...
     *     
     */
    public void setStateIsoCodeRer(String value) {
        this.stateIsoCodeRer = value;
    }
