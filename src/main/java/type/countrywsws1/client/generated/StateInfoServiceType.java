...
public interface StateInfoServiceType {
    ...
    public ListOffContinent listOfContinentsByName();
    ...
    public ListOffContinent listOfContinentsByCode();
    ...
    public ListOffCurr listOfCurrenciesByName();
    ...
    public ListOffCurr listOfCurrenciesByCode();
    ...
    public ListOffCoAndNa listOfCountryNamesByCode();
    ...
    public ListOffCoAndNa listOfCountryNamesByName();
    ...
    public ListOffStateCAndNGRCon listOfCountryNamesGroupedByContinent();
    ...
    public TypeCurrency countryCurrency(
        @WebParam(name = "sCountryISOCode", targetNamespace = "http://www.oorsprong.org/websamples.countryinfo")
        String sCountryISOCode);
    ...
    public TypeCountryInfo fullCountryInfo(
        @WebParam(name = "sCountryISOCode", targetNamespace = "http://www.oorsprong.org/websamples.countryinfo")
        String sCountryISOCode);
    ...
    public ListOffStateInfo fullCountryInfoAllCountries();
    ...
    public ListOffCoAndNa countriesUsingCurrency(
    ...
    public ListOffLang listOfLanguagesByName();
    ...
    public ListOffLang listOfLanguagesByCode();
