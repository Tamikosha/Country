...
@XmlType(name = "ListOffCurr", propOrder = {
        "typeCurrency"
})
public class ListOffCurr {

    @XmlElement(nillable = true)
    protected List<TypeCurrency> typeCurrency;
     ...
     * 
     */
    public List<TypeCurrency> getTCurrency() {
        if (typeCurrency == null) {
            typeCurrency = new ArrayList<TypeCurrency>();
        }
