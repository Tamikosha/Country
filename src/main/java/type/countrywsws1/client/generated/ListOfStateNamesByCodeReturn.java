...
public class ListOfStateNamesByCodeReturn {

    @XmlElement(name = "ListOfCountryNamesByCodeResult", required = true)
    protected ListOffCoAndNa listOfCountryNamesByCodeResult;
     ...
     *     
     */
    public ListOffCoAndNa getListOfCountryNamesByCodeResult() {
     ...
     *     
     */
    public void setListOfCountryNamesByCodeResult(ListOffCoAndNa value) {
